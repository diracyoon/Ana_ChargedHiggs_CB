void Run_Fitter_Performance()
{
  ...
  fitter_performance->Investigation_Fitter_Failure_2B();
  fitter_performance->Investigation_Fitter_Failure_3B();
  fitter_performance->Reconstruction_Result_Chi2_2B();
  fitter_performance->Reconstruction_Result_Chi2_3B();
  fitter_performance->Reconstruction_Result_Chi2_Piece_2B();
  fitter_performance->Reconstruction_Result_Chi2_Piece_3B();
